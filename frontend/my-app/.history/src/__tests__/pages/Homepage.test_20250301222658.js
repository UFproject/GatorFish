...
describe('Homepage', () => {
    ...
    test('shows login success notification when coming from login page', () => {
        // We need to restore the previous mock and create a new one for this test
        jest.resetModules();

        // Create a special render function for this test
        const renderWithLoginState = () => {
            // Mock useLocation with fromLogin true
        ...
        // Now check for the notification
