...
jest.mock('../../page/Product', () => {
  const MockProduct = () => (
    <div>
      ...
      <button onClick={() => window.handleLiked()}>Add to Favorites</button>
    </div>
  );
  
  // Export component with same functions as original
  return {
    __esModule: true,
    default: MockProduct
  };
...
describe('Product Page', () => {
  beforeEach(() => {
    ...
    // Setup global handler for Add to Favorites click
    window.handleLiked = jest.fn().mockImplementation(async () => {
      try {
