...
describe('Product Page', () => {
    ...
    test('renders correct product image', async () => {
        ...
        const imageElement = await waitFor(() => screen.getByAltText('Test Product'));
    ...
    test('adds product to favorites when "Add to Favorites" button is clicked', async () => {
        ...
        const addToFavoritesButton = await waitFor(() => screen.getByText('Add to Favorites'));
    ...
    test('links to seller profile page', async () => {
        ...
        // Find the seller link - wait for it to render
        const sellerLink = await waitFor(() => screen.getByText('Test Seller').closest('a'));
